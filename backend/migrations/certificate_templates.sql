-- ============================================================
-- Jamaat-e-Islami Hind — Certificate Templates Schema Extension
-- ============================================================
...
CREATE TABLE IF NOT EXISTS certificate_template_fields (
    ...
    x_position    NUMERIC(6,3) NOT NULL DEFAULT 10, -- % of width
    y_position    NUMERIC(6,3) NOT NULL DEFAULT 10, -- % of height
